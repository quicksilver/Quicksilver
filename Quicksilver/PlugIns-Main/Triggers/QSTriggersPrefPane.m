...
- (void)populateTypeMenu{
	...
	NSDictionary *managers=[QSReg elementsByIDForPointID:@"QSTriggerManagers"];
	...
	while(key=[e nextObject]){
		manager=[[managers objectForKey:key] elementInstance];
...
- (NSMutableArray *)triggerSets { 
	{
		NSMutableDictionary *sets=[QSReg elementsByIDForPointID:@"QSTriggerSets"];
