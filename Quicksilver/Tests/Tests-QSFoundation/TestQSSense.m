...
- (void)testLongString {
	...
	XCTAssertEqualWithAccuracy(score, 0.881481, ACC);
	...
	XCTAssertEqualWithAccuracy(score, 0.8737327, ACC);
	...
	XCTAssertEqualWithAccuracy(score, 0.674285, ACC);
	...
	XCTAssertEqualWithAccuracy(score, 0.383753, ACC);
