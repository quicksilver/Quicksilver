...
//    NSMenuItem			*menuItem;
	...
	//NSLog(@"image %@",menuImage);
	//NSLog(@"image %@",pressedMenuImage);
...
- (void)connectionDidInitialize:(NSNotification*)notif{
	...
	NSLog(@"Connection Initialized: %d",[notif object]);
}
- (void)connectionDidDie:(NSNotification*)notif{
	...
	if ([notif object]==connection){
		...
		NSLog(@"Connection Died: %d",[notif object]);
