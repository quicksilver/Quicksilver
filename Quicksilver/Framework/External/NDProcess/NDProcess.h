...
/*!
	...
	@abstract Returns a new <tt>NDProcess</tt>.
	@discussion Returns a <tt>NDProcess</tt> for the process with the UNIX process ID <tt><i>pid</i></tt>. WARNING: this method returns an instance that will be reused unless you retain it.
	@result A <tt>NDProcess</tt> object.
 */
