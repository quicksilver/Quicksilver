...
- (void)setSearchArray:(NSArray *)newSearchArray {
	// NSLog(@"searcharray:%d %d %d", self, newSearchArray, [newSearchArray count]);
...
- (NSData *)scoreData { return scoreData;  }
...
- (void)partialStringChanged {
	...
	if (fALPHA)
		...
		[[NSUserDefaults standardUserDefaults] floatForKey:kSearchDelay];
