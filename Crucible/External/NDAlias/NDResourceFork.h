...
/*!
	@functiongroup Creating resource fork instance
 */

/*!
	@method dataWithContentsOfURL:type:Id:
	@abstract Gets resource data for a resource in the receivers resource file.
	@discussion <tt>dataWithContentsOfType:Id:</tt> searches the receivers resource file's resource map in memory for the specified resource.
 ...
 */
+ (NSData *)dataWithContentsOfURL:(NSURL *)URL type:(ResType)type Id:(short int)ID;
/*!
	@method dataWithContentsOfURL:type:named:
	@abstract Gets resource data for a resource in the receivers resource file.
	@discussion <tt>dataWithContentsOfType:Id:</tt> searches the receivers resource file's resource map in memory for the specified resource.
	@param type The resource type of the resource which you wish to read data.
	...
	@result Returns an <tt>NSData</tt> object if successful otherwise returns nil.
 */
+ (NSData *)dataWithContentsOfURL:(NSURL *)URL type:(ResType)type named:(NSString *)name;
/*!
	@method dataWithContentsOfFile:type:Id
	@abstract Gets resource data for a resource in the receivers resource file.
	@discussion <tt>dataWithContentsOfType:Id:</tt> searches the receivers resource file's resource map in memory for the specified resource.
	@param type The resource type of the resource which you wish to read data.
	@param ID An integer that uniquely identifies the resource which you wish to read data.
	@result Returns an <tt>NSData</tt> object if successful otherwise returns nil.
 */
+ (NSData *)dataWithContentsOfFile:(NSString *)path type:(ResType)type Id:(short int)ID;
/*!
	@method dataWithContentsOfFile:type:named:
	@abstract Gets resource data for a resource in the receivers resource file.
	@discussion <tt>dataWithContentsOfType:Id:</tt> searches the receivers resource file's resource map in memory for the specified resource.
	@param type The resource type of the resource which you wish to read data.
	@param name A name that uniquely identifies the resource which you wish to read data. Strings passed in this parameter are case-sensitive.
	@result Returns an <tt>NSData</tt> object if successful otherwise returns nil.
 */
+ (NSData *)dataWithContentsOfFile:(NSString *)path type:(ResType)type named:(NSString *)name;
/*!
...
/*!
	@functiongroup Adding data to an in memory resource fork
 */
...
/*!
	@functiongroup Retrieve data from a resource fork
 */
...
/*!
	@functiongroup Remove data from a resource fork
 */
...
/*!
	@functiongroup Obtain information about data with a resource fork
 */
...
/*!
	...
	@param type The resource type of the resource for which you wish to read the name.
	@param ID An integer that uniquely identifies the resource for which you wish to read the name.
...
/*!
	...
	@param type The resource type of the resource for which you wish to read the id.
	@param name The resource name of the resource for which you wish to read the id.
...
/*!
	...
	@param type The resource type of the resource for which you wish to read the attributes.
	@param ID An integer that uniquely identifies the resource for which you wish to read the attributes.
	@result A <tt>YES</tt> if retrieval was successful.
  */
...
/*!
	@functiongroup Get and set the entire resource fork data.
 */
...
/*!
	@functiongroup Creat a <tt>NSData</tt> instance from file resource fork data
 */

/*!
	@method dataWithResourceForkContentsOfURL:type:Id:
	@abstract Create a <tt>NSData</tt> instance.
	@discussion Data for the resource type <tt><i>type</i></tt> and resource id <tt><i>ID</i></tt> is read from the file URL <tt><i>URL</i></tt> and returned as a <tt>NSData</tt> instance.
	@param URL A file url specifying the name and location of the file whose resource fork is to be read from.
	@param type The resource type of the resource which you wish to read data.
	@param ID An integer that uniquely identifies the resource which you wish to read data.
	@result If successful an <tt>NSData</tt> instance with the resource fork data of the resource type and resource id.
 */
...
/*!
	...
	@abstract Create a <tt>NSData</tt> instance.
	@discussion Data for the resource type <tt><i>type</i></tt> and resource name <tt><i>name</i></tt> is read from the file URL <tt><i>URL</i></tt> and returned as a <tt>NSData</tt> instance.
	@param URL A file url specifying the name and location of the file whose resource fork is to be read from.
	@param type The resource type of the resource which you wish to read data.
	@param name A name that uniquely identifies the resource which you wish to read data. Strings passed in this parameter are case-sensitive.
	@result If successful an <tt>NSData</tt> instance with the resource fork data of the resource type and resource name.
 */
...
/*!
	...
	@abstract Create a <tt>NSData</tt> instance.
	@discussion Data for the resource type <tt><i>type</i></tt> and resource id <tt><i>ID</i></tt> is read from the file <tt><i>path</i></tt> and returned as a <tt>NSData</tt> instance.
	@param path A file path specifying the file whose resource fork is to be read from.
	@param type The resource type of the resource which you wish to read data.
	@param ID An integer that uniquely identifies the resource which you wish to read data.
	@result If successful an <tt>NSData</tt> instance with the resource fork data of the resource type and resource id.
 */
...
/*!
	...
	@abstract Create a <tt>NSData</tt> instance.
	@discussion Data for the resource type <tt><i>type</i></tt> and resource name <tt><i>name</i></tt> is read from the file <tt><i>path</i></tt> and returned as a <tt>NSData</tt> instance.
	@param path A file path specifying the file whose resource fork is to be read from.
	@param type The resource type of the resource which you wish to read data.
	@param name A name that uniquely identifies the resource which you wish to read data. Strings passed in this parameter are case-sensitive.
	@result If successful an <tt>NSData</tt> instance with the resource fork data of the resource type and resource name.
...
/*!
	@functiongroup Write to file resource fork data
 */

/*!
	@method writeToResourceForkURL:type:Id:name:
	@abstract write a <tt>NSData</tt> instance to a resource fork.
	@discussion Data is written to the resource type <tt><i>type</i></tt> and resource id <tt><i>ID</i></tt> is read from the file URL <tt><i>URL</i></tt> and returned as a <tt>NSData</tt> instance.
	@param URL A file url specifying the name and location of the file whose resource fork is to be written to.
	@param type The resource type of the resource which you wish to write data to.
	@param ID An integer that uniquely identifies the resource which you wish to write data to.
	@param name A name that uniquely identifies the resource. Strings passed in this parameter are case-sensitive.
	@result Returns <tt>YES</tt> if successful, other <tt>NO</tt>.
 */
...
/*!
	...
	@abstract write a <tt>NSData</tt> instance to a resource fork.
	@discussion Data is written to the resource type <tt><i>type</i></tt> and resource id <tt><i>ID</i></tt> is read from the file <tt><i>PATH</i></tt> and returned as a <tt>NSData</tt> instance.
	@param path A file path specifying the file whose resource fork is to be written to.
	@param type The resource type of the resource which you wish to write data to.
	@param ID An integer that uniquely identifies the resource which you wish to write data to.
	@param name A name that uniquely identifies the resource. Strings passed in this parameter are case-sensitive.
	@result Returns <tt>YES</tt> if successful, other <tt>NO</tt>.
